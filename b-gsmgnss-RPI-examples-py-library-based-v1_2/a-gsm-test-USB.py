############################################################################################################################################
#a-gsm-test-USB.py v1.01/24 March 2017 - a-gsmII/b-gsmgnss 2.105 test USB communication utility
...
if(serialCommunicationVia!=USBCON):
    ...
    print("Read config how to in a-gsm-test-SERIAL.py. Configure the hardware and after that run a-gsm-test-SERIAL.py\r\n")
