############################################################################################################################################
#agsm_Basic_Lib.py v1.01/24 March 2017 - a-gsmII/b-gsmgnss 2.105 BASIC FUNCTIONS library 
...
#activateTopSIM()
#   call this function if you want to test/use SIM inserted in the SIM SOCKET placed on BOTTOM of the a-gsm dual SIM socket
def activatePrimarySIM():
    setActiveSIM(0)

#activateBottomSIM()
#   call this function if you want to test/use SIM inserted in the SIM SOCKET placed SIM SOCKET placed on TOP of the a-gsm dual SIM socket
