############################################################################################################################################
#a-gsm-HTTP.py v1.01/24 March 2017 - a-gsmII/b-gsmgnss 2.105 HTTP (POST/GET w or wo SSL) client utility / demo
...
sleep(3)
print "\r\n\r\n***DATA plan needed & check the DATA settings(GPRS_context,GPRS_user,GPRS_password) in \"agsm_HTTP_Lib.py\"***\r\n"
...
startSerialCom()                        # open serial communication bw. RPi and agsm shield
